...
void ShowTransferLogByAccountScreen()
{
    system("cls");
    cout << "\n=========================================\n";
    cout << "\tFind Transfer Log Screen\n";
    cout << "=========================================\n";
...
void PerformTransactionMenuOption(enTransactionMenuOption Option)
{
    ...
    case enTransactionMenuOption::eTotalBalance:
        ...
        GoBackToTransactionMenu();
        break;
    case enTransactionMenuOption::eTransferBalance:
        TransferScreen();
        GoBackToTransactionMenu();
        break;
    case enTransactionMenuOption::eTransferLog:
        ...
        GoBackToTransactionMenu();
        break;
    case enTransactionMenuOption::eSearchTransferLog:
        ShowTransferLogByAccountScreen();
        GoBackToTransactionMenu();
        break;
...
void TransactionMenuScreen()
{
    ...
    do
    {
        ...
        cout << "\t [5] Transfer Log!\n";
        cout << "\t [6] Sreach Transform Log!\n";
        cout << "\t [7] Main Menu Screen!\n";
        cout << "====================================================\n";

        Option = enTransactionMenuOption(ReadOption(1, 7));
        PerformTransactionMenuOption(Option);

    } while (Option != enTransactionMenuOption::eMainMenu);
}
...
void PerformUserMenuOpton(enUsersMenuOption UserOption)
{
    ...
    case enUsersMenuOption::DeleteUsser:
        ...
        GoBackToUserMenuScreen();
        break;
    case enUsersMenuOption::MainMenu:
        break;
    }
}
